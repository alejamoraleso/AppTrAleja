...
let url =   'https://api.sheety.co/e4e8e8f4c10c0697467b11d4295e9c9f/alejaBdTrello'; //Bd  en produccion 

//funcion para peticion get axios para obtener listas (columnas) y crearlas segun registro de bd
...
getDatosListasBd() //llamado de funcion get datos listas al iniciar programa

//funcion para peticion get axios para obtener tareas y crearlas segun registro bd
const getDatosTareaBd = async () => {
 ...
 getDatosTareaBd();  //llamado de funcion get datos tareas al iniciar programa  
